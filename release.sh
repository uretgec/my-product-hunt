...
MANIFEST_VERSION="${ARGS[1]}" # 3: Chrome, 2: Firefox
...
then
    ...
    zip -r $WHEREIAM/build/my-product-hunt-$BUILD_NUMBER_NEW-v$MANIFEST_VERSION.zip * -x "*.DS_Store" -x "__MACOSX" -x "*_original.css"
